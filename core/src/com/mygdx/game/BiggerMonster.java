...
public class BiggerMonster extends Enemy {
    ...
    public BiggerMonster(SpriteBatch newBatch) {
        batch = newBatch;
        createAnimation();
    ...
    public void createAnimation() {
        zombieSheet = new Texture(Gdx.files.internal("biggermonster.png"));

        TextureRegion[][] tmp = TextureRegion.split(zombieSheet, 30, zombieSheet.getHeight());
